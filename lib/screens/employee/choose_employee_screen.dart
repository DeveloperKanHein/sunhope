...
class ChooseEmployeeScreen extends StatefulWidget {
  const ChooseEmployeeScreen({super.key});

  @override
  State<ChooseEmployeeScreen> createState() => _ChooseEmployeeScreenState();
}

class _ChooseEmployeeScreenState extends State<ChooseEmployeeScreen> {
